...
router.post('/ai-draft',authMiddleware.verifyToken,quotationscontroller.generateQuotationDraft);
router.post('/:id/approve', authMiddleware.verifyToken,quotationscontroller.approveQuotation);
