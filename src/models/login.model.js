...
Login.checkUserValid = (postArr, result) => {
    ...
    var loginqry = `SELECT bls_users.ID as user_id,bls_users.sDisplayName as name,bls_users.sEmail as email,bls_users.sMobile as mobile,bls_users.sUserName as username,bls_users.sPassword as password,bls_users.sEncPassword as encPassword, bls_users.iStatus as status,bls_users.iUserType as user_type FROM bls_users WHERE bls_users.sUserName ='${username}'`;
